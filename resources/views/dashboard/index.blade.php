...
<link href="dashboard.css" rel="stylesheet">
  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <img src="img/header title.png"  height="40" class="col-md-3 col-lg-2 me-0 px-3">
            ...
            <a>
              <form action="/logout" method="post">
                ...
                <li class="nav-item list-unstyled  ">
                  ...
                  <a href="/login" class="nav-link link-light {{ ($title === "login") ? 'active' : '' }}" > <i class="bi bi-box-arrow-in-left "></i> Login</a>
                </li>
                @endauth
              </form>
            </a>
